      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text('Product List', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF232B3A))),
            const SizedBox(height: 8),
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  if (product.imageUrl.isNotEmpty && File(product.imageUrl).existsSync()) {
                    imageWidget = Image.file(File(product.imageUrl), width: 40, height: 40, fit: BoxFit.cover);
                  } else if (product.imageUrl.isNotEmpty) {
                    imageWidget = Image.network(product.imageUrl, width: 40, height: 40, fit: BoxFit.cover);
                  } else {
                  ...
                  return Card(
                    child: ListTile(
                      ...
                      subtitle: Text('₱${product.price} | Size: ${product.size} | Color: ${product.color}${product.isFeatured ? " | Featured" : ""}'),
                    ),
                  );
                },
              ),
